...
if("TRUE" STREQUAL "TRUE")
  set(cougarbot_SOURCE_PREFIX /home/cerlab/Armbot_ws/src/cougarbot)
  set(cougarbot_DEVEL_PREFIX /home/cerlab/Armbot_ws/devel)
  ...
  set(cougarbot_INSTALL_PREFIX /home/cerlab/Armbot_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'cougarbot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'cougarbot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cerlab/Armbot_ws/src/cougarbot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT cougarbot_NUM_DUMMY_TARGETS)
      set(cougarbot_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::cougarbot::wrapped-linker-option${cougarbot_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR cougarbot_NUM_DUMMY_TARGETS "${cougarbot_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::cougarbot::wrapped-linker-option${cougarbot_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND cougarbot_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/cerlab/Armbot_ws/devel/lib;/home/cerlab/Armbot_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${cougarbot_dep}_FOUND)
      find_package(${cougarbot_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${cougarbot_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(cougarbot_EXPORTED_TARGETS ${${cougarbot_dep}_EXPORTED_TARGETS})
endforeach()
